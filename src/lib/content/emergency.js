...
تب، ضربه به سر، مصرف دارو (مسمومیت)، علل هیپوکسی (غرق‌شدگی، آسپیراسیون)، سابقه صرع، سرگیجه، دوبینی، تهوع/استفراغ (ICP بالا)، در فرد با سابقه مصرف  دارو ضد تشنج (عدم مصرف  دارو / عدم تناسب میزان دارو با وزن جدید /  بیماری های عفونی).

## معاینه

آیا تشنج متوقف‌شده یا ادامه دارد (gaze، سفتی اندام، حرکات کلونیک، مردمک میدریاز، افزایش ضربان قلب)، سطح هوشیاری، مردمک‌ها (سایز، میوتیک=اپیوم، پاسخ به نور، آنیزوکوریا)،ردور، کرنیگ/برودزینسکی، فونتانل (بالج/دپرس)، DTR، پلانتار رفلکس، آثار تروما به سر، علائم نوروکوتانئوس، هپاتواسپلنومگالی، تغییر رنگ مو.
